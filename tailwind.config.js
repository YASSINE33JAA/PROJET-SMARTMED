...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: { sm: 'var(--shadow-sm)', md: 'var(--shadow-md)', lg: 'var(--shadow-lg)', xl: 'var(--shadow-xl)', glow: 'var(--shadow-glow)' },
      keyframes: {
        "fade-in": { from: { opacity: 0 }, to: { opacity: 1 } },
        "float": { "0%,100%": { transform: "translateY(0)" }, "50%": { transform: "translateY(-10px)" } }
      },
      animation: { "fade-in": "fade-in 0.5s ease-out forwards", "float": "float 6s ease-in-out infinite" },
    },
  },
