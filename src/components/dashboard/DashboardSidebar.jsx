...
const menuItems = {
  ...
  medecin: [
    ...
    { icon: Clock, label: "Mon Planning", href: "/dashboard/medecin/schedule" },
    { icon: Users, label: "Mes Patients", href: "/dashboard/medecin/patients" },
    { icon: Calendar, label: "Rendez-vous", href: "/dashboard/medecin/appointments" },
    { icon: ClipboardList, label: "Ordonnances", href: "/dashboard/medecin/prescriptions" },
  ...
  patient: [
    ...
    { icon: Stethoscope, label: "Prendre RDV", href: "/dashboard/patient/book" },
