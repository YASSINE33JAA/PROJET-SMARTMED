    ...
    <DashboardLayout role="medecin" userName="Dr. Amina Benjelloun">
      ...
      <Dialog open={viewPatient !== null} onOpenChange={() => setViewPatient(null)}>
        ...
        <DialogContent>
          ...
          <DialogHeader>
            <DialogTitle>
              Dossier patient — {viewPatient?.name}
            </DialogTitle>
          </DialogHeader>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <span className="font-medium">{viewPatient.age} ans</span>
                </div>
                ...
                <div>
                  ...
                  <span className="font-medium">{viewPatient.lastVisit}</span>
                </div>

                <div>
                  <span className="text-muted-foreground">Nombre de visites:</span>{" "}
                  <span className="font-medium">{viewPatient.visits}</span>
                </div>
