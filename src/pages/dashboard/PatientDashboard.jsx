import { Calendar, Users, Clock, TrendingUp, ArrowUp, ArrowDown, FileText } from "lucide-react";
...
// Stats cards
const stats = [
  { title: "Rendez-vous du jour", value: "8", change: "+2", trend: "up", icon: Calendar, color: "bg-primary/10 text-primary" },
  { title: "Nouveaux patients", value: "12", change: "+4", trend: "up", icon: Users, color: "bg-success/10 text-success" },
  { title: "En attente", value: "3", change: "-1", trend: "down", icon: Clock, color: "bg-warning/10 text-warning" },
  { title: "Taux de satisfaction", value: "98%", change: "+2%", trend: "up", icon: TrendingUp, color: "bg-accent/10 text-accent" },
];
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              {[
                ...
                { label: "Voir mes documents", icon: FileText, href: "/dashboard/patient/documents" },
                { label: "Modifier mon profil", icon: Users, href: "/dashboard/patient/profile" },
              ].map((action) => {
