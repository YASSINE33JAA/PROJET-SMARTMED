        ...
        <div className="grid gap-6 max-w-2xl">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              {[
                { label: "Rappels de rendez-vous", desc: "Recevoir un rappel avant chaque rendez-vous", defaultChecked: true },
                { label: "Notifications par email", desc: "Recevoir les notifications par email", defaultChecked: false },
                { label: "Notifications SMS", desc: "Recevoir les notifications par SMS", defaultChecked: false },
              ].map((n) => (
          ...
          <Button variant="hero" onClick={() => toast({ title: "Paramètres sauvegardés" })}>
