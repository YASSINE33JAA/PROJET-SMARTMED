...
const PatientBook = () => {
  ...
  const handleBook = () => {
    toast({
      ...
      description: `Avec ${doctor} le ${date} à ${time}.`,
    });
    setStep(4);
  };
    ...
    <DashboardLayout role="patient" userName="Mohammed Bouabdelli">
      ...
      >
        ...
        {step === 1 && (
          <Card>
            <CardHeader>
              <CardTitle>Choisir une spécialité</CardTitle>
            </CardHeader>
        ...
        {step === 2 && (
          <Card>
            <CardHeader>
              <CardTitle>Choisir un médecin — {specialty}</CardTitle>
            </CardHeader>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea placeholder="Décrivez brièvement le motif..." />
              </div>
