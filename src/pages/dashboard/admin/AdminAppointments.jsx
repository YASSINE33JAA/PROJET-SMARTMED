                    ...
                    <TableCell className="text-right">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <DropdownMenuItem onClick={() => setViewApt(a)}>
        ...
        <DialogContent>
          ...
          {viewApt && (
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
                <span className="text-muted-foreground">Patient:</span> <span className="font-medium">{viewApt.patient}</span>
              </div>
              <div>
                <span className="text-muted-foreground">Médecin:</span> <span className="font-medium">{viewApt.doctor}</span>
              </div>
              <div>
                <span className="text-muted-foreground">Date:</span> <span className="font-medium">{viewApt.date}</span>
              </div>
              <div>
                <span className="text-muted-foreground">Heure:</span> <span className="font-medium">{viewApt.time}</span>
              </div>
              <div>
                <span className="text-muted-foreground">Statut:</span>{" "}
                <span className={`px-2 py-1 rounded-full text-xs font-medium ${statusMap[viewApt.status].cls}`}>
